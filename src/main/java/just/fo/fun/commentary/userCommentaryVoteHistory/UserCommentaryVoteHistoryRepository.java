...
public interface UserCommentaryVoteHistoryRepository extends JpaRepository<UserCommentaryVoteHistory, Long> {
    ...
    @Query("select UP from UserCommentaryVoteHistory UP " +
            "where UP.isDeleted = false " +
            "and UP.commentary.isDeleted = false " +
            "and UP.commentary.user.isDeleted = false " +
            "and UP.commentary.post.isDeleted = false " +
