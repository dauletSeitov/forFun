...
public class VoteService {
    ...
    public void postChangeRating(Boolean isUpVote, User user, Long postId){
        ...
        UserPostVoteHistory userPostVoteHistory = userPostVoteHistoryRepository.findByUserAndPostNotDeleted(user.getId(), postId);
    ...
    public void commentChangeRating(Boolean isUpVote, User user, Long commentId){
        ...
        UserCommentaryVoteHistory userCommentaryVoteHistory = userCommentaryVoteHistoryRepository.findByUserAndPostNotDeleted(user.getId(), commentId);
