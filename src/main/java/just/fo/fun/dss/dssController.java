...
public class dssController {
    ...
    public static void main(String[] args) {
        ...
        intitFromFile(positiveSet, "/home/bagdaulet/Desktop/apdmin-panel/positive.txt");
        intitFromFile(negativeSet, "/home/bagdaulet/Desktop/apdmin-panel/negative.txt");
        ...
        for (String word : words){
            ...
            if(positiveSet.contains(word)){
                positiveWordCount++;
                positiveSelectedWords.add(word);
            }

            if(negativeSet.contains(word)){
                negativeWordCount++;
                negativeSelectedWords.add(word);
            }
        }
    ...
    private static void intitFromFile(Set<String> set, String filePath){
